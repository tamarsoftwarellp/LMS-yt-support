...
export function StudentPortal({
  ...
  const TOTAL_STEPS = STUDENT_STEPS.length;

  const isCompleted = (s: number) => s < step;

  /*
   * Student step components
   *
   * IMPORTANT:
   * The step number is 1-based.
   */
  ...
  /*
   * Safe step information.
   */
  const currentStep = STUDENT_STEPS[step - 1];

  /*
   * Prevent undefined access if something accidentally
   * sends step outside the valid range.
   */
  if (!currentStep) {
    return (
      <div
        className="min-h-screen flex items-center justify-center bg-[#F2F5FC]"
        style={{ fontFamily: "var(--font-sans)" }}
      >
        <div className="bg-white rounded-2xl border border-[--border] shadow-sm p-8 text-center">
          <h2 className="text-lg font-semibold text-[#0F1C3F]">
            Invalid Student Portal Step
          </h2>
          ...
          <button
            onClick={() => setStep(1)}
            className="mt-5 px-5 py-2 bg-[#1B3A6B] text-white rounded-[10px]"
          >
            Go to Step 1
          </button>
        </div>
  ...
  return (
    ...
    >
      ...
      <div
        className="max-w-[1200px] mx-auto px-7 py-7 grid gap-5"
        style={{
      ...
      >
                  ...
                  {ph.range.map((sid) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-left mb-0.5 transition-all ${
                          active
                            ? "bg-[#EBF1FA]"
                            : done
                            ? "hover:bg-[#F4F7FC] cursor-pointer"
        ...
        <main className="bg-white rounded-2xl border border-[--border] shadow-sm overflow-hidden">
          ...
          <div className="px-8 py-5 border-b border-[--border] flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2.5">
                ...
                {(step === 3 ||
                  ...
                  <span className="flex items-center gap-1 text-[10.5px] font-semibold text-amber-700 bg-amber-50 border border-amber-200 px-2 py-0.5 rounded-full">
            ...
            <span
              className="text-[11.5px] text-[#9AA5BE]"
              style={{
          ...
          <div className="px-8 py-5 border-t border-[--border] flex items-center justify-between">
            ...
            {step < TOTAL_STEPS ? (
              ...
              <button
                onClick={onLMS}
                className="flex items-center gap-2 px-5 py-2 bg-[#D97706] text-white text-[13.5px] rounded-[10px] hover:bg-[#b45309] transition-colors font-medium shadow-sm"
              >
...
export function CollegePortal({
  ...
  const CollegeCurrentIcon = currentStep.icon;
              ...
              {phases.map((ph) => (
                ...
                >
                  ...
                  {ph.range.map((sid) => {
                    ...
                    /*
                     * College steps are also 1-based.
                     */
