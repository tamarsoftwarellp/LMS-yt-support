...
revision = "20260915_16_coding_tests"
...
def upgrade() -> None:
    with op.batch_alter_table("course_lessons") as batch:
        batch.drop_constraint("ck_course_lessons_type", type_="check")
        batch.create_check_constraint("ck_course_lessons_type",
