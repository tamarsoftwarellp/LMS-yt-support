...
from .coding_test_router import admin_router as admin_coding_test_router, student_router as student_coding_test_router
...
app.include_router(admin_coding_test_router)
app.include_router(student_coding_test_router)
