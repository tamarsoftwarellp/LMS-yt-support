    ...
    >
      ...
      <div className="max-w-[900px] mx-auto px-7 py-12">
        ...
        <div className="bg-white border border-[--border] rounded-2xl p-6 mb-6 shadow-sm">
          <p className="text-[13px] font-semibold text-[#9AA5BE] uppercase tracking-widest mb-4">
            Table of Contents
          </p>
          <div className="space-y-2">
            {sections.map((s) => (
              ...
              >
                ...
                <span className="flex-1 text-[13.5px] text-[#0F1C3F] font-medium">
                  {s.title}
                </span>
                <span
                  className="text-[12px] text-[#9AA5BE]"
                  style={{ fontFamily: "var(--font-mono)" }}
                >
                  p. {s.pages}
                </span>
        ...
        {(onPrompt || onSRS) && (
          <div className="mt-8 border-t border-[--border] pt-6">
            <p className="text-[13px] text-[#5A6A8A] mb-4 text-center">
