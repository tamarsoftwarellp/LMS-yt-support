    ...
    >
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-[--border]">
        <div className="max-w-[1200px] mx-auto px-7 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden p-2 text-[#5A6A8A]"
          >
        ...
        {navOpen && (
          <div className="md:hidden border-t border-[--border] bg-white px-7 py-4 space-y-2">
            {["Features", "Portals", "Pricing", "Stories", "FAQ"].map(
              (item) => (
                <a
                  ...
                  className="block py-2 text-[13.5px] font-medium text-[#5A6A8A] hover:text-[#1B3A6B]"
                >
                  {item}
                </a>
              ),
            ...
            <div className="pt-3 flex flex-col gap-2">
              <button
                onClick={onStudentLogin ?? onStudent}
                className="w-full py-2.5 border border-[--border] rounded-[10px] text-[13px] font-medium text-[#1B3A6B] flex items-center justify-center gap-2"
              >
                <LogIn size={13} />
                Student Login
              </button>
              ...
              <button
                onClick={onCollege}
                className="w-full py-2.5 bg-[#1B3A6B] rounded-[10px] text-[13px] font-semibold text-white"
              >
                Register College
              </button>
            </div>
      ...
      <section className="relative overflow-hidden bg-[#0A1629]">
        ...
        <div className="relative max-w-[1200px] mx-auto px-7 py-24 text-center">
          ...
          <h1
            className="text-[52px] md:text-[64px] font-bold text-white leading-[1.08] mb-6 max-w-3xl mx-auto"
          ...
          <div className="flex items-center justify-center gap-4 -mt-8 mb-10">
            <button
              onClick={onStudentLogin ?? onStudent}
              className="flex items-center gap-1.5 text-[12.5px] text-white/60 hover:text-white/90 transition-colors"
            >
      ...
      <section id="portals" className="bg-[#F4F6FB] py-20">
        <div className="max-w-[1200px] mx-auto px-7">
          <div className="text-center mb-10">
            ...
            <h2
              className="text-[36px] font-bold text-[#0F1C3F] mt-2"
              style={{ fontFamily: "var(--font-serif)" }}
            >
            ...
            {(activeTab === "college" ? collegeFeatures : studentFeatures).map(
              (f) => {
                ...
                return (
                  <div
                    key={f.title}
                    className="bg-white border border-[--border] rounded-2xl p-5 hover:shadow-md hover:-translate-y-0.5 transition-all group"
                  >
      ...
      <section id="features" className="bg-white py-20">
        <div className="max-w-[1200px] mx-auto px-7">
          <div className="text-center mb-14">
            <span className="text-[11px] font-semibold tracking-widest text-[#D97706] uppercase">
              Step by Step
            </span>
            <h2
              className="text-[36px] font-bold text-[#0F1C3F] mt-2"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <p className="text-[16px] font-bold text-[#0F1C3F]">
                  For Colleges
                </p>
              </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.step} className="flex gap-5">
                      <div className="w-8 h-8 rounded-full bg-[#1B3A6B] text-white text-[12px] font-bold flex items-center justify-center shrink-0 z-10 shadow-sm">
                        {item.step}
                      </div>
              ...
              <button
                onClick={onCollege}
                className="mt-6 flex items-center gap-2 px-5 py-2.5 bg-[#1B3A6B] text-white text-[13.5px] rounded-xl hover:bg-[#122748] transition-colors font-semibold"
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.step} className="flex gap-5">
                      <div className="w-8 h-8 rounded-full bg-[#D97706] text-white text-[12px] font-bold flex items-center justify-center shrink-0 z-10 shadow-sm">
                        {item.step}
                      </div>
                      <div className="flex-1 pb-2">
                        <p className="text-[13.5px] font-semibold text-[#0F1C3F]">
              ...
              <button
                onClick={onStudent}
                className="mt-6 flex items-center gap-2 px-5 py-2.5 bg-[#D97706] text-white text-[13.5px] rounded-xl hover:bg-[#b45309] transition-colors font-semibold"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
            {[
              ...
              return (
                ...
                >
                  <div className="w-9 h-9 rounded-lg bg-amber-400/15 flex items-center justify-center mb-3">
        ...
        <div className="max-w-[1200px] mx-auto px-7">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="bg-[#F4F6FB] border border-[--border] rounded-2xl p-6"
              >
      ...
      <section id="pricing" className="bg-[#F4F6FB] py-20">
        <div className="max-w-[1200px] mx-auto px-7">
          <div className="text-center mb-12">
            ...
            <p className="text-[14px] text-[#5A6A8A] mt-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-3xl mx-auto">
            {plans.map((p) => (
              <div
                key={p.name}
                className={`border-2 rounded-2xl p-6 relative ${p.color}`}
              >
                {p.badge && (
                  <span
                    className={`absolute -top-3 left-1/2 -translate-x-1/2 text-[11px] font-bold px-3 py-1 rounded-full ${p.name === "Growth" ? "bg-[#1B3A6B] text-white" : "bg-[#D97706] text-white"}`}
                  >
                    {p.badge}
                  </span>
                )}
                <p className="text-[15px] font-bold text-[#0F1C3F] mb-1">
                  {p.name}
                </p>
                <p
                  className="text-[28px] font-bold text-[#0F1C3F] mb-0.5"
                  style={{ fontFamily: "var(--font-serif)" }}
                >
                  {p.price}
                  <span className="text-[13px] font-normal text-[#5A6A8A]">
                    {p.price !== "Free" && p.price !== "Custom"
                      ? "/student"
                      : ""}
                  </span>
                </p>
                <p className="text-[12.5px] text-[#5A6A8A] mb-5">
                  {p.students}
                </p>
                <div className="space-y-2 mb-6">
                  {[
                    ...
                    .map((f) => (
                      <div
                        key={f}
                        className="flex items-center gap-2 text-[12.5px] text-[#5A6A8A]"
                      >
                        <Check
                          size={13}
          ...
          <div className="space-y-2">
            {faqs.map((faq, i) => (
              ...
              >
                ...
                >
                  <span className="text-[14px] font-medium text-[#0F1C3F]">
                    {faq.q}
                  </span>
                  <ChevronDown
                    size={16}
                    className={`text-[#5A6A8A] shrink-0 ml-3 transition-transform ${activeFaq === i ? "rotate-180" : ""}`}
                  />
                </button>
                {activeFaq === i && (
      ...
      <section className="bg-[#0A1629] py-20">
        <div className="max-w-[900px] mx-auto px-7 text-center">
          <h2
            className="text-[40px] font-bold text-white mb-4"
            style={{ fontFamily: "var(--font-serif)" }}
          >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            >
              <GraduationCap size={17} /> I&apos;m a Student{" "}
              <ArrowRight size={15} />
            </button>
          </div>
        </div>
